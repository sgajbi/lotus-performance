...
_RULE_RUNTIME_RETENTION_CLEANUP_RUN_WRITE = (
    f"{_HTTP_METHOD_POST}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RUNTIME_RETENTION_CLEANUP_RUN}"
)
_RULE_RECOVERY_DRILL_RUN_WRITE = (
    f"{_HTTP_METHOD_POST}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RECOVERY_DRILL_RUN}"
)
_RULE_RUNTIME_STATUS_READ = f"{_HTTP_METHOD_GET}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RUNTIME_STATUS}"
_RULE_RUNTIME_WORK_ITEMS_READ = f"{_HTTP_METHOD_GET}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RUNTIME_WORK_ITEMS}"
_RULE_RUNTIME_RECOVERIES_READ = f"{_HTTP_METHOD_GET}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RUNTIME_RECOVERIES}"
_RULE_RECOVERY_DRILLS_READ = f"{_HTTP_METHOD_GET}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RECOVERY_DRILLS}"
_RULE_RUNTIME_RETENTION_CLEANUPS_READ = (
    f"{_HTTP_METHOD_GET}{_CAPABILITY_RULE_METHOD_PATH_SEPARATOR}{_PATH_RUNTIME_RETENTION_CLEANUPS}"
)
