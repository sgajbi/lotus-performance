...
_PATH_PERFORMANCE_LINEAGE = "/performance/lineage"
_PATH_PERFORMANCE_INSPECTIONS = "/performance/inspections"
...
_RULE_PERFORMANCE_LINEAGE_READ = _capability_rule_key(method=_HTTP_METHOD_GET, path=_PATH_PERFORMANCE_LINEAGE)
_RULE_PERFORMANCE_INSPECTIONS_READ = _capability_rule_key(method=_HTTP_METHOD_GET, path=_PATH_PERFORMANCE_INSPECTIONS)
...
_DEFAULT_PRIVILEGED_READ_RULES = {
    ...
    _RULE_PERFORMANCE_LINEAGE_READ: _CAPABILITY_OPERATIONS_RUNTIME_READ,
    _RULE_PERFORMANCE_INSPECTIONS_READ: _CAPABILITY_OPERATIONS_RUNTIME_READ,
}
