        ...
        AnalyticsSurfaceCapability(
            ...
            contract_notes=(
                [
                    ...
                    "source-economics inspection now covers fee and external cash-flow classification, duplicate source signals, positive fee sign anomalies, and fee or external source-total mismatches",
                ]
                if twr_enabled
                else []
            ),
