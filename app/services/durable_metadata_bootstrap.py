...
def bootstrap_durable_metadata_stores(
    *,
    execution_store: ExecutionRegistry = execution_registry,
    compute_store: ComputeJobStore = compute_job_store,
    async_result_store_: AsyncResultStore = async_result_store,
    lineage_store: LineageMetadataStore = lineage_metadata_store,
) -> None:
