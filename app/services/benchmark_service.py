...
def calculate_benchmark_response(
    ...
    *,
    ...
    try:
        ...
        response_model = _build_completed_benchmark_response(
...
def _build_completed_benchmark_response(
    *,
    benchmark_request: BenchmarkPerformanceRequest,
...
def _complete_benchmark_execution(
    *,
    benchmark_request: BenchmarkPerformanceRequest,
    benchmark_artifacts: BenchmarkCalculationArtifacts,
