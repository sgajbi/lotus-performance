...
def analyze_source_economics(
    *,
    ...
    findings = build_source_economics_findings(
        ...
        fee_mixed_timing_samples=samples.fee_mixed_timing_samples,
        ...
        external_mixed_timing_samples=samples.external_mixed_timing_samples,
...
def _build_evidence_summary(
    *,
    ...
    return {
        ...
        "fee_cashflow_mixed_timing_date_count": len(fee_mixed_timing_samples),
        ...
        "external_cashflow_mixed_timing_date_count": len(external_mixed_timing_samples),
...
def _build_artifact_payload(
    *,
    ...
    return {
        ...
        "fee_cashflow_mixed_timing_date_count": len(fee_mixed_timing_samples),
        "fee_cashflow_mixed_timing_samples": fee_mixed_timing_samples[:_SAMPLE_LIMIT],
        "external_cashflow_normalization_gap_count": len(external_normalization_samples),
        ...
        "external_cashflow_mixed_timing_date_count": len(external_mixed_timing_samples),
        "external_cashflow_mixed_timing_samples": external_mixed_timing_samples[:_SAMPLE_LIMIT],
        "conflicting_explicit_source_amount_date_count": len(conflicting_explicit_amount_samples),
