...
def analyze_source_economics(
    *,
    ...
    for source_point in source_points:
        ...
        if (
            source_point.detailed_fee_bod != 0 or source_point.detailed_fee_eod != 0
        ) and source_point.normalized_mgmt_fees == 0:
        ...
        if source_point.detailed_external_bod != 0 or source_point.detailed_external_eod != 0:
            if not _amounts_match(source_point.normalized_bod_cf, source_point.detailed_external_bod) or not _amounts_match(
                source_point.normalized_eod_cf,
                source_point.detailed_external_eod,
            ):
