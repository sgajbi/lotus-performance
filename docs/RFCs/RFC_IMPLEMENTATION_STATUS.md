...
2.  **RFC 045 — TWR Inspection and Supportability Contract**
    ...
    * **Malformed-observation-date note, 2026-04-15:** Source-economics inspection now warns when a portfolio observation is missing a usable `valuation_date`, preserving malformed observation identity as upstream contract evidence instead of silently dropping the row.
