...
| Slice 7 - API Contract, OpenAPI, and Downstream Consumer Alignment | In progress | `docs/RFCs/RFC-047-api-contract-downstream-slice7.md`; `lotus-gateway` PR `sgajbi/lotus-gateway#206` preserves source-owned contribution return and evidence, `lotus-workbench` PR `sgajbi/lotus-workbench#177` renders exact source-economics and smoothing statuses. Gateway CI is green; Workbench CI must finish green before closure. |
