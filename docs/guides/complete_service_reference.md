...
| `CALCULATION_ENGINE_VERSION` | `lotus-performance-calculation-engine.v2` | governed methodology/hash identity version used by calculation hashes; separate from build identity and `/version` metadata |
