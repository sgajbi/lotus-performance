...
- alert: LotusPerformanceRecoveryDrillPolicyBreached
  ...
  annotations:
    ...
    description: "The latest retained recovery drill is stale, failed, or repeatedly recovering stale governed-action leases."
    runbook: "docs/runbooks/runtime-alerts.md"
```
...
- alert: LotusPerformanceRuntimeRetentionPolicyBreached
  ...
  annotations:
    ...
    description: "The latest retained runtime-retention cleanup is stale, was not applied, or is repeatedly recovering stale governed-action leases."
    runbook: "docs/runbooks/runtime-alerts.md"
```
