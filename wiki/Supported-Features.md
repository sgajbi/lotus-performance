...
| Workspace summary | Interaction-efficient performance summary for product surfaces | `POST /performance/workspace-summary` | Product-oriented summary contract for Gateway and Workbench. It emits source-owned `calculation_supportability`, consumes performance-owned calculations without downstream reconstruction, and binds async success publication to same-calculation lineage metadata plus `lineage_materialization` completion. |
