...
| Validation lane discipline | Fast local and PR-grade gates cover lint, formatting, typecheck, contracts, observability-readiness markers, docs, security, migrations, Docker, and tests. | `make check`, `make quality-observability-readiness-gate`, `make ci`, `make ci-local`, `Makefile`, `README.md`, [Validation and CI](Validation-and-CI) | Delivery and client-project teams can connect feature claims to repeatable release evidence. |
