...
| Python LOC | 104,454 | 158,035 | measured | prior measured value plus current Python diff line delta |
...
| Collected tests | 2,035 | 3,100 | measured | `python -m pytest --collect-only -q` |
