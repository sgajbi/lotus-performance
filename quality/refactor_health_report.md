...
| High-complexity functions | unknown | 7 | measured | rank D-F functions in `quality/complexity_inventory.md` |
...
| Collected tests | 2,035 | 2,199 | measured | `python -m pytest --collect-only -q` |
