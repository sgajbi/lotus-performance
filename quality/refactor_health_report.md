...
| Python LOC | 104,454 | 163,133 | measured | `rg --files -g '*.py'` plus PowerShell line count on this branch |
...
| Collected tests | 2,035 | 3,175 | measured | `python -m pytest --collect-only -q` |
