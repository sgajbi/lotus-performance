...
| Collected tests | 2,035 | 3,752 | measured | `python -m pytest --collect-only -q` |
...
| Uncategorized test functions | unknown | 951 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #429 added workspace-summary operator-navigation API path proof while staying below the uncategorized ceiling |
