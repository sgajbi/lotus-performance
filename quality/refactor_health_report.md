...
| Python LOC | 104,454 | 124,105 | measured | recursive `.py` line count |
...
| Average maintainability index | unknown | 55.19 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,502 | measured | `python -m pytest --collect-only -q` |
