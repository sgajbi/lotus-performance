...
| Largest functions by LOC | unknown | 60 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; LP-CR-1498 moved `_calculate_xirr_mwr_attempt(...)` out of the top-25 table, and the largest production functions continue to measure `60` lines |
...
| Collected tests | 2,035 | 3,254 | measured | `python -m pytest --collect-only -q` |
