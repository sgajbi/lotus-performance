...
| --- | ---: | ---: | --- | --- |
| Python files | 480 | 538 | measured | `rg --files -g '*.py'` |
| Python package markers | 18 | 18 | measured | recursive `__init__.py` count |
| Python LOC | 104,454 | 117,012 | measured | recursive `.py` line count |
...
| Collected tests | 2,035 | 2,294 | measured | `python -m pytest --collect-only -q` |
