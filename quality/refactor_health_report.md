...
| Contract/governance test functions | unknown | 147 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
| Uncategorized test functions | unknown | 950 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #431 added calculation-engine-version policy and gate coverage without growing the uncategorized backlog |
