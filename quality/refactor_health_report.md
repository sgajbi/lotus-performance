...
| Python LOC | 104,454 | 157,903 | measured | prior measured value plus current Python diff line delta |
...
| Collected tests | 2,035 | 3,092 | measured | `python -m pytest --collect-only -q` |
