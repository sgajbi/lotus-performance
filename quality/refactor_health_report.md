...
| Average maintainability index | unknown | 55.74 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,246 | measured | `python -m pytest --collect-only -q` |
