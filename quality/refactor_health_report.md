...
| Python LOC | 104,454 | 163,615 | measured | `rg --files -g '*.py'` plus Python line count on this branch |
...
| Collected tests | 2,035 | 3,186 | measured | `python -m pytest --collect-only -q` |
