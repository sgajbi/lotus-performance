...
| Python LOC | 104,454 | 154,876 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 54.84 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 3,000 | measured | `python -m pytest --collect-only -q` |
