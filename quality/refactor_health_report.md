...
| Python LOC | 104,454 | 116,143 | measured | recursive `.py` line count |
...
| Average maintainability index | unknown | 55.64 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,278 | measured | `python -m pytest --collect-only -q` |
