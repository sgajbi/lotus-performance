...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 293 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,672 | measured | `python -m pytest --collect-only -q` |
...
1. Ratcheted `make quality-test-taxonomy-gate` from older accepted floors to the current measured
   preservation baseline: `651` API/runtime test functions, `128` contract/governance test
