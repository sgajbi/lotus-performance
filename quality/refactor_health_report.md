...
| Python LOC | 104,454 | 109,730 | measured | recursive `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Max cyclomatic complexity | unknown | 38 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,120 | measured | `python -m pytest --collect-only -q` |
