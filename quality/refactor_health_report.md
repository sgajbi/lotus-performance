...
| Average maintainability index | unknown | 55.79 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,219 | measured | `python -m pytest --collect-only -q` |
