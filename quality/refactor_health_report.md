...
| API completeness findings | unknown | 29 | measured | `quality/api_completeness_inventory.md` via `scripts/openapi_completeness_inventory.py` |
...
| Error responses not expressed as problem-detail contracts | unknown | 16 | measured | `ERROR_RESPONSE_NOT_PROBLEM_DETAIL` in `quality/api_completeness_inventory.md` |
