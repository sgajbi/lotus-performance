...
| Python LOC | 104,454 | 155,512 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 54.81 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 3,030 | measured | `python -m pytest --collect-only -q` |
