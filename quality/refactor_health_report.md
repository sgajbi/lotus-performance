...
| Python LOC | 104,454 | 157,924 | measured | prior measured value plus current Python diff line delta |
...
| Collected tests | 2,035 | 3,094 | measured | `python -m pytest --collect-only -q` |
