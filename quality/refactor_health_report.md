...
| Python LOC | 104,454 | 155,122 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 54.83 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 3,011 | measured | `python -m pytest --collect-only -q` |
