...
| Largest functions by LOC | unknown | 62 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; LP-CR-1489 moved `_resolve_subject_inspection_inputs(...)` out of the top-25 table, and the largest production functions now measure `62` lines |
...
| Collected tests | 2,035 | 3,246 | measured | `python -m pytest --collect-only -q` |
