...
| Python LOC | 104,454 | 111,552 | measured | recursive `.py` line count |
...
| High-complexity functions | unknown | 15 | measured | rank D-F functions in `quality/complexity_inventory.md` |
...
| Collected tests | 2,035 | 2,182 | measured | `python -m pytest --collect-only -q` |
