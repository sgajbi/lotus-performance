...
| Duplicate code hotspots | 0 | 15 | enforced | `quality/duplicate_code_inventory.md`; `make quality-duplicate-code-gate` with `--min-lines 12 --max-groups 15` |
...
| Collected tests | 2,035 | 3,106 | measured | `python -m pytest --collect-only -q` |
