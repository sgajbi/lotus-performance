...
| Python LOC | 104,454 | 121,014 | measured | recursive `.py` line count |
...
| Average maintainability index | unknown | 55.46 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,399 | measured | `python -m pytest --collect-only -q` |
