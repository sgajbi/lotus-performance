...
| Python LOC | 104,454 | 184,938 | measured | `rg --files -g '*.py'` plus Python line count on this branch |
...
| Collected tests | 2,035 | 3,625 | measured | `python -m pytest --collect-only -q` |
