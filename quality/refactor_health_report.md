...
| --- | ---: | ---: | --- | --- |
| Python files | 480 | 555 | measured | `rg --files -g '*.py'` |
| Python package markers | 18 | 18 | measured | recursive `__init__.py` count |
| Python LOC | 104,454 | 159,630 | measured | `rg --files -g '*.py'` plus PowerShell line count on this branch |
...
| Largest functions by LOC | unknown | 101 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; contribution period result builders moved from `102`/`102` to `92`/`90` lines in LP-CR-1412 |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 266 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,129 | measured | `python -m pytest --collect-only -q` |
