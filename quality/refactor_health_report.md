...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 321 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,967 | measured | `python -m pytest --collect-only -q` |
...
| Integration/API/runtime test functions | unknown | 699 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
| Contract/governance test functions | unknown | 177 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
| Uncategorized test functions | unknown | 876 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #475 classified the workspace analytics surface, moving 90 tests out of `uncategorized`, and re-banked the ceiling from `969` to the measured `879` in the same change |
