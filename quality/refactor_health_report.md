...
| Collected tests | 2,035 | 4,064 | measured | `python -m pytest --collect-only -q` |
...
| Integration/API/runtime test functions | unknown | 749 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
