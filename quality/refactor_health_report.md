...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 317 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,895 | measured | `python -m pytest --collect-only -q` |
...
| Integration/API/runtime test functions | unknown | 696 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
