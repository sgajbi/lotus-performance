...
| Python LOC | 104,454 | 158,007 | measured | prior measured value plus current Python diff line delta |
...
| Collected tests | 2,035 | 3,098 | measured | `python -m pytest --collect-only -q` |
