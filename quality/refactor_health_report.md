...
| Python LOC | 104,454 | 110,964 | measured | recursive `.py` line count |
...
| High-complexity functions | unknown | 18 | measured | rank D-F functions in `quality/complexity_inventory.md` |
...
| Collected tests | 2,035 | 2,165 | measured | `python -m pytest --collect-only -q` |
