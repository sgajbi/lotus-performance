...
| Python LOC | 104,454 | 163,636 | measured | `rg --files -g '*.py'` plus Python line count on this branch |
...
| Collected tests | 2,035 | 3,187 | measured | `python -m pytest --collect-only -q` |
