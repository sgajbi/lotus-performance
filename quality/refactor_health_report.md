...
| Python LOC | 104,454 | 153,366 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 54.90 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,930 | measured | `python -m pytest --collect-only -q` |
