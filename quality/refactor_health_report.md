...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 295 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,675 | measured | `python -m pytest --collect-only -q` |
...
| Integration/API/runtime test functions | unknown | 654 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
...
1. Ratcheted `make quality-test-taxonomy-gate` from older accepted floors to the current measured
   preservation baseline: `654` API/runtime test functions, `128` contract/governance test
