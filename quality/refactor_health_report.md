...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 312 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,865 | measured | `python -m pytest --collect-only -q` |
...
| Contract/governance test functions | unknown | 155 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
| Uncategorized test functions | unknown | 879 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #475 classified the workspace analytics surface, moving 90 tests out of `uncategorized`, and re-banked the ceiling from `969` to the measured `879` in the same change |
