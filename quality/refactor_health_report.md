...
| Python LOC | 104,454 | 114,697 | measured | recursive `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Max cyclomatic complexity | unknown | 17 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
| High-complexity functions | unknown | 0 | measured | rank D-F functions in `quality/complexity_inventory.md` |
| Average maintainability index | unknown | 55.72 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 253 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 2,251 | measured | `python -m pytest --collect-only -q` |
