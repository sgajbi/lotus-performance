...
| Python LOC | 104,454 | 118,989 | measured | recursive `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Max cyclomatic complexity | unknown | 10 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
| High-complexity functions | unknown | 0 | measured | rank D-F functions in `quality/complexity_inventory.md` |
| Average maintainability index | unknown | 55.55 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,348 | measured | `python -m pytest --collect-only -q` |
