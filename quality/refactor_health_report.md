...
| --- | ---: | ---: | --- | --- |
| Python files | 480 | 546 | measured | `rg --files -g '*.py'` |
| Python package markers | 18 | 18 | measured | recursive `__init__.py` count |
| Python LOC | 104,454 | 157,307 | measured | `rg --files -g '*.py'` recursive `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 262 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,074 | measured | `python -m pytest --collect-only -q` |
