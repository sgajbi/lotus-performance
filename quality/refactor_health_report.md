...
| Python LOC | 104,454 | 120,067 | measured | recursive `.py` line count |
...
| Average maintainability index | unknown | 55.51 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,375 | measured | `python -m pytest --collect-only -q` |
