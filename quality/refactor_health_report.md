...
| Largest functions by LOC | unknown | 65 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; LP-CR-1475 moved `run_source_quality_checks(...)` out of the top-25 table, while the largest production functions continue to measure `65` lines |
...
| Collected tests | 2,035 | 3,231 | measured | `python -m pytest --collect-only -q` |
