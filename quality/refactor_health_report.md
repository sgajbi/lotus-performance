...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Import boundary violations | unknown | 9 | measured | `quality/architecture_boundary_inventory.md` via `scripts/python_architecture_boundary_inventory.py` |
...
| Domain/application importing framework or infra code | unknown | 9 | measured | `DOMAIN_INFRA_OR_FRAMEWORK_IMPORT` in `quality/architecture_boundary_inventory.md` |
