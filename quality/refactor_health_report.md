...
| Router/middleware oversized function findings (`--threshold 80`) | unknown | 8 | measured | `quality/router_middleware_thinness_inventory.md` via `scripts/python_router_middleware_thinness_inventory.py` |
