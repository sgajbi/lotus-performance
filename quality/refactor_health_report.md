...
| Python LOC | 104,454 | 149,107 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 55.02 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,768 | measured | `python -m pytest --collect-only -q` |
