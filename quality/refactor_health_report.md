...
| Python LOC | 104,454 | 158,163 | measured | prior measured value plus current Python diff line delta |
...
| Collected tests | 2,035 | 3,103 | measured | `python -m pytest --collect-only -q` |
