...
| Python LOC | 104,454 | 111,505 | measured | recursive `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Max cyclomatic complexity | unknown | 27 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
| High-complexity functions | unknown | 17 | measured | rank D-F functions in `quality/complexity_inventory.md` |
| Average maintainability index | unknown | 55.86 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,179 | measured | `python -m pytest --collect-only -q` |
