...
| Uncategorized test functions | unknown | 966 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; RFC-0002 Idea opportunity source-proof tests stay below the uncategorized ceiling |
