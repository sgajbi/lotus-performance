...
| Collected tests | 2,035 | 4,001 | measured | `python -m pytest --collect-only -q` |
...
| Contract/governance test functions | unknown | 183 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
