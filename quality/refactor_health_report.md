...
| Python LOC | 104,454 | 151,050 | measured | recursive tracked `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 260 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 2,836 | measured | `python -m pytest --collect-only -q` |
