...
| Python LOC | 104,454 | 153,526 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 54.89 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,945 | measured | `python -m pytest --collect-only -q` |
