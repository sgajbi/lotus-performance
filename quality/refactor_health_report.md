...
| Python LOC | 104,454 | 111,655 | measured | recursive `.py` line count |
...
| High-complexity functions | unknown | 16 | measured | rank D-F functions in `quality/complexity_inventory.md` |
...
| Collected tests | 2,035 | 2,181 | measured | `python -m pytest --collect-only -q` |
