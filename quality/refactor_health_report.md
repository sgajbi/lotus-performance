...
| API completeness findings | unknown | 8 | measured | `quality/api_completeness_inventory.md` via `scripts/openapi_completeness_inventory.py` |
...
| JSON error responses missing explicit schema | unknown | 4 | measured | `ERROR_JSON_MISSING_SCHEMA` in `quality/api_completeness_inventory.md` |
| Error responses not expressed as problem-detail contracts | unknown | 4 | measured | `ERROR_RESPONSE_NOT_PROBLEM_DETAIL` in `quality/api_completeness_inventory.md` |
