...
| Collected tests | 2,035 | 3,731 | measured | `python -m pytest --collect-only -q` |
...
| Integration/API/runtime test functions | unknown | 665 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
...
| Uncategorized test functions | unknown | 968 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #434 added retrieval metadata anti-corruption coverage while preserving the `969` blocking ceiling |
