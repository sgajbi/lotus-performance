...
| Duplicate code hotspots | 0 | 14 | enforced | `quality/duplicate_code_inventory.md`; `make quality-duplicate-code-gate` with `--min-lines 12 --max-groups 14` |
...
| Collected tests | 2,035 | 3,107 | measured | `python -m pytest --collect-only -q` |
