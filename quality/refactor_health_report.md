...
| Largest functions by LOC | unknown | 61 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; LP-CR-1493 moved `_build_twr_inspection_response(...)` out of the top-25 table, and the largest production functions continue to measure `61` lines |
...
| Collected tests | 2,035 | 3,250 | measured | `python -m pytest --collect-only -q` |
