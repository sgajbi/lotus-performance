...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 304 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 3,745 | measured | `python -m pytest --collect-only -q` |
...
| Integration/API/runtime test functions | unknown | 685 | enforced | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
...
| Uncategorized test functions | unknown | 951 | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #430 added ordered-array reproducibility hash-contract proof while staying below the uncategorized ceiling |
