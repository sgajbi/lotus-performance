...
| Python LOC | 104,454 | 147,884 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 55.07 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,716 | measured | `python -m pytest --collect-only -q` |
