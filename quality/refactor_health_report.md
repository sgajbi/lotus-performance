...
| Largest functions by LOC | unknown | 98 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; LP-CR-1416 moved `_build_analytics_surfaces(...)` from `113` to `93` lines by isolating synchronous capability-surface projection |
...
| Collected tests | 2,035 | 3,136 | measured | `python -m pytest --collect-only -q` |
