...
| Python LOC | 104,454 | 118,332 | measured | recursive `.py` line count |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Max cyclomatic complexity | unknown | 11 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
| High-complexity functions | unknown | 0 | measured | rank D-F functions in `quality/complexity_inventory.md` |
| Average maintainability index | unknown | 55.58 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
| Largest functions by LOC | unknown | 189 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py` |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 256 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 2,332 | measured | `python -m pytest --collect-only -q` |
