...
| Python LOC | 104,454 | 159,514 | measured | `rg --files -g '*.py'` plus PowerShell line count on this branch |
...
| Largest functions by LOC | unknown | 102 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; `build_runtime_status_response` moved from `113` to `91` lines in LP-CR-1411 |
...
| Collected tests | 2,035 | 3,126 | measured | `python -m pytest --collect-only -q` |
