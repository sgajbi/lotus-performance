...
| --- | ---: | ---: | --- | --- |
| Python files | 480 | 542 | measured | `rg --files -g '*.py'` |
| Python package markers | 18 | 18 | measured | recursive `__init__.py` count |
| Python LOC | 104,454 | 122,382 | measured | recursive `.py` line count |
...
| Average maintainability index | unknown | 55.24 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Metric | Baseline | Current | Status | Evidence |
| --- | ---: | ---: | --- | --- |
| Test modules | 228 | 258 | measured | `rg --files tests -g 'test_*.py'` |
| Collected tests | 2,035 | 2,430 | measured | `python -m pytest --collect-only -q` |
