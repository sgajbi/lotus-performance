...
| Python LOC | 104,454 | 162,986 | measured | `rg --files -g '*.py'` plus PowerShell line count on this branch |
...
| Collected tests | 2,035 | 3,171 | measured | `python -m pytest --collect-only -q` |
