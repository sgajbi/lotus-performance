...
| Python LOC | 104,454 | 148,728 | measured | recursive tracked `.py` line count |
...
| Average maintainability index | unknown | 55.04 | measured | `quality/complexity_inventory.md` via `scripts/python_complexity_inventory.py` |
...
| Collected tests | 2,035 | 2,749 | measured | `python -m pytest --collect-only -q` |
