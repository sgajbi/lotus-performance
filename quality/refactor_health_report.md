...
| High-complexity functions | unknown | 1 | measured | rank D-F functions in `quality/complexity_inventory.md` |
...
| Collected tests | 2,035 | 2,207 | measured | `python -m pytest --collect-only -q` |
