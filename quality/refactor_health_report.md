...
| Python LOC | 104,454 | 159,432 | measured | `rg --files -g '*.py'` plus PowerShell line count on this branch |
...
| Largest functions by LOC | unknown | 113 | measured | `quality/function_size_inventory.md` via `scripts/python_function_size_inventory.py`; `_build_analytics_surfaces` moved from `130` to `101` lines in LP-CR-1410 |
...
| Collected tests | 2,035 | 3,125 | measured | `python -m pytest --collect-only -q` |
