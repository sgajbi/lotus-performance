...
| Python LOC | 104,454 | 111,654 | measured | recursive `.py` line count |
...
| High-complexity functions | unknown | 14 | measured | rank D-F functions in `quality/complexity_inventory.md` |
...
| Collected tests | 2,035 | 2,184 | measured | `python -m pytest --collect-only -q` |
