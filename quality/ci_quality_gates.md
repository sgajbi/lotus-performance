...
| Dependency hygiene | Measured in `quality/dependency_hygiene_report.md` through `scripts/python_dependency_hygiene_inventory.py` and `deptry`; direct imported transitive dependencies are closed, leaving two runtime-review DEP002 findings | Review runtime-only declarations before blocking. |
