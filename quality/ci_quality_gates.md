...
| Test taxonomy | Blocking through `make quality-test-taxonomy-gate`, which runs `scripts/python_test_taxonomy_inventory.py --limit 30 --min-api-runtime-tests 656 --min-contract-governance-tests 136 --max-uncategorized-tests 671`; current AST inventory shows 327 modules, 3,843 source test functions, 770 integration/API/runtime test functions, 193 contract/governance test functions, 551 observability/readiness test functions, 266 quality/security test functions, 1,797 analytics-domain test functions, and 671 uncategorized test functions | Keep the measured preservation baseline blocking. #532 classified execution-registry/lifecycle, lineage-metadata/service, and PostgreSQL concurrency tests as runtime-readiness evidence and re-banked the ceiling from 772 to 671; focused classifier tests guard against silent overmatching. Earlier #475, #504, and #529 classifier corrections remain historical evidence. `operator` remains the largest unclassified group. |
...
Current governed inventory: `quality/test_taxonomy_inventory.md` records 327 test modules, 3,843
source test functions, 770 API/runtime test functions, 193 contract/governance test functions, and
671 uncategorized test functions. The full family summary is 327 modules, 3,843 source test
functions, 770 integration/API/runtime test functions, 193 contract/governance test functions, 551
observability/readiness test functions, 266 quality/security test functions, 1,797 analytics-domain
test functions, and 671 uncategorized test functions.

`quality/test_taxonomy_inventory.md` records 327 test modules, 3,843 source test functions, 770 API/runtime test functions, 193 contract/governance test functions, and 671 uncategorized test functions.
