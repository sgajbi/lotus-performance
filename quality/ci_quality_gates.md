...
| Test taxonomy | Blocking through `make quality-test-taxonomy-gate`, which runs `scripts/python_test_taxonomy_inventory.py --limit 30 --min-api-runtime-tests 656 --min-contract-governance-tests 136 --max-uncategorized-tests 969`; current AST inventory shows 309 modules, 3,542 source test functions, 690 integration/API/runtime test functions, 154 contract/governance test functions, 355 observability/readiness test functions, 168 quality/security test functions, 1,571 analytics-domain test functions, and 962 uncategorized test functions | Keep the current measured preservation baseline blocking. Classify domain tests through stable taxonomy rules instead of allowing uncategorized growth. |
...
Current governed inventory: `quality/test_taxonomy_inventory.md` records 309 test modules, 3,542
source test functions, 690 API/runtime test functions, 154 contract/governance test functions, and
962 uncategorized test functions. The full family summary is 309 modules, 3,542 source test
functions, 690 integration/API/runtime test functions, 154 contract/governance test functions, 355
observability/readiness test functions, 168 quality/security test functions, 1,571 analytics-domain
test functions, and 962 uncategorized test functions.

`quality/test_taxonomy_inventory.md` records 309 test modules, 3,542 source test functions, 690 API/runtime test functions, 154 contract/governance test functions, and 962 uncategorized test functions.
