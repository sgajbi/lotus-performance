...
functions, 690 integration/API/runtime test functions, 155 contract/governance test functions, 371
...
`quality/test_taxonomy_inventory.md` records 312 test modules, 3,588 source test functions, 690 API/runtime test functions, 155 contract/governance test functions, and 876 uncategorized test functions.
