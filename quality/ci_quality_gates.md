...
Current governed inventory: `quality/test_taxonomy_inventory.md` records 327 test modules, 3,761
source test functions, 749 API/runtime test functions, 188 contract/governance test functions, and
797 uncategorized test functions. The full family summary is 327 modules, 3,761 source test
functions, 749 integration/API/runtime test functions, 188 contract/governance test functions, 430
observability/readiness test functions, 264 quality/security test functions, 1,710 analytics-domain
test functions, and 797 uncategorized test functions.

`quality/test_taxonomy_inventory.md` records 327 test modules, 3,761 source test functions, 749 API/runtime test functions, 188 contract/governance test functions, and 797 uncategorized test functions.
