...
Current governed inventory: `quality/test_taxonomy_inventory.md` records 323 test modules, 3,680
source test functions, 701 API/runtime test functions, 178 contract/governance test functions, and
825 uncategorized test functions. The full family summary is 323 modules, 3,680 source test
functions, 701 integration/API/runtime test functions, 178 contract/governance test functions, 429
observability/readiness test functions, 237 quality/security test functions, 1,674 analytics-domain
test functions, and 825 uncategorized test functions.

`quality/test_taxonomy_inventory.md` records 323 test modules, 3,680 source test functions, 701 API/runtime test functions, 178 contract/governance test functions, and 825 uncategorized test functions.
