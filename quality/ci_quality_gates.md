...
| Test taxonomy | Blocking through `make quality-test-taxonomy-gate`, which runs `scripts/python_test_taxonomy_inventory.py --limit 30 --min-api-runtime-tests 656 --min-contract-governance-tests 136 --max-uncategorized-tests 879`; current AST inventory shows 311 modules, 3,576 source test functions, 690 integration/API/runtime test functions, 155 contract/governance test functions, 366 observability/readiness test functions, 183 quality/security test functions, 1,662 analytics-domain test functions, and 879 uncategorized test functions | Keep the current measured preservation baseline blocking. Classify domain tests through stable taxonomy rules instead of allowing uncategorized growth. Issue #475 classified the workspace analytics surface and re-banked the ceiling from `969` to the measured `879`; `runtime` and `operator` remain the two largest unclassified groups. |
...
Current governed inventory: `quality/test_taxonomy_inventory.md` records 311 test modules, 3,576
source test functions, 690 API/runtime test functions, 155 contract/governance test functions, and
879 uncategorized test functions. The full family summary is 311 modules, 3,576 source test
functions, 690 integration/API/runtime test functions, 155 contract/governance test functions, 366
observability/readiness test functions, 183 quality/security test functions, 1,662 analytics-domain
test functions, and 879 uncategorized test functions.

`quality/test_taxonomy_inventory.md` records 311 test modules, 3,576 source test functions, 690 API/runtime test functions, 155 contract/governance test functions, and 879 uncategorized test functions.
