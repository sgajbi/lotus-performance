...
Current governed inventory: `quality/test_taxonomy_inventory.md` records 327 test modules, 3,793
source test functions, 757 API/runtime test functions, 188 contract/governance test functions, and
772 uncategorized test functions. The full family summary is 327 modules, 3,793 source test
functions, 757 integration/API/runtime test functions, 188 contract/governance test functions, 431
observability/readiness test functions, 266 quality/security test functions, 1,763 analytics-domain
test functions, and 772 uncategorized test functions.

`quality/test_taxonomy_inventory.md` records 327 test modules, 3,793 source test functions, 757 API/runtime test functions, 188 contract/governance test functions, and 772 uncategorized test functions.
