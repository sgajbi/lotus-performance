...
| Combined line coverage under branch run | 99.52% | `covered_lines / num_statements` from `output/branch-coverage/coverage.json` |
| Covered lines | 21142 | coverage.py `7.14.3` JSON totals |
| Missing lines | 102 | coverage.py `7.14.3` JSON totals |
| Statements | 21244 | coverage.py `7.14.3` JSON totals |
| Combined branch coverage | 97.59% | 4300 covered branches of 4406 total branches |
| Missing branches | 106 | coverage.py `7.14.3` JSON totals |
| Partial branches | 106 | coverage.py `7.14.3` JSON totals |
