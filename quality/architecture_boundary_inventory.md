...
| Metric | Value |
| --- | ---: |
| Architecture boundary findings | 19 |
| Distinct rules | 2 |
| Distinct files | 11 |
...
| `ROUTER_DIRECT_BOUNDARY_IMPORT` | 5 |
...
| 15 | `ROUTER_DIRECT_BOUNDARY_IMPORT` | `app/api/endpoints/performance.py:53` | `core.envelope` | API routers should route through app services/use cases instead of direct domain, engine, or infrastructure imports. |
| 16 | `ROUTER_DIRECT_BOUNDARY_IMPORT` | `app/api/endpoints/performance.py:54` | `core.repro` | API routers should route through app services/use cases instead of direct domain, engine, or infrastructure imports. |
| 17 | `ROUTER_DIRECT_BOUNDARY_IMPORT` | `app/api/endpoints/performance.py:55` | `engine.exceptions` | API routers should route through app services/use cases instead of direct domain, engine, or infrastructure imports. |
| 18 | `ROUTER_DIRECT_BOUNDARY_IMPORT` | `app/api/endpoints/performance.py:56` | `engine.mwr` | API routers should route through app services/use cases instead of direct domain, engine, or infrastructure imports. |
| 19 | `ROUTER_DIRECT_BOUNDARY_IMPORT` | `app/api/endpoints/performance.py:227` | `core.workspace_periods` | API routers should route through app services/use cases instead of direct domain, engine, or infrastructure imports. |
