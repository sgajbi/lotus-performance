...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `_reconcile_stale_job_row` | method | `app/services/compute_job_store.py:546` | 6 | B |
| 2 | `calculate_contribution_workflow` | function | `app/services/contribution_calculation_workflow_service.py:199` | 6 | B |
| 3 | `_is_average_weight_shadow_cutover_candidate` | function | `app/services/contribution_methodology.py:263` | 6 | B |
| 4 | `_calculate_position_total_return_pct` | function | `app/services/contribution_returns.py:67` | 6 | B |
| 5 | `_build_hierarchy_from_adjusted_position_series` | function | `app/services/contribution_series.py:176` | 6 | B |
| 6 | `_build_period_contribution_series_outputs` | function | `app/services/contribution_service.py:188` | 6 | B |
| 7 | `_prepare_contribution_engine_inputs` | function | `app/services/contribution_service.py:414` | 6 | B |
| 8 | `_contribution_smoothing_residual_reason_codes` | function | `app/services/contribution_smoothing.py:60` | 6 | B |
| 9 | `_available_stateless_economics` | function | `app/services/contribution_source_economics.py:86` | 6 | B |
| 10 | `_unsupported_component_pnl_fields` | function | `app/services/contribution_source_economics.py:129` | 6 | B |
| 11 | `load_json_object_or_none` | function | `app/services/durable_store_json.py:9` | 6 | B |
| 12 | `load_json_string_list_or_default` | function | `app/services/durable_store_json.py:31` | 6 | B |
| 13 | `record_upstream_snapshots` | method | `app/services/execution_registry.py:542` | 6 | B |
| 14 | `_is_replay_of_existing_execution` | method | `app/services/execution_registry.py:638` | 6 | B |
| 15 | `_check_portfolio_daily_calculation_evidence` | function | `app/services/inspection/calculation_consistency.py:391` | 6 | B |
| 16 | `_comparative_return_component_mismatch` | function | `app/services/inspection/calculation_consistency.py:713` | 6 | B |
| 17 | `_select_latest_position_rows` | function | `app/services/inspection/reconciliation.py:459` | 6 | B |
| 18 | `_build_position_continuity_gap_sample` | function | `app/services/inspection/reconciliation.py:567` | 6 | B |
| 19 | `_row_has_transition_activity` | function | `app/services/inspection/reconciliation.py:602` | 6 | B |
| 20 | `_cash_flows_have_nonzero_amount` | function | `app/services/inspection/reconciliation.py:633` | 6 | B |
| 21 | `_collect_duplicate_snapshot_samples` | function | `app/services/inspection/reconciliation.py:645` | 6 | B |
| 22 | `_build_observation_source_economics` | function | `app/services/inspection/source_economics.py:439` | 6 | B |
| 23 | `_read_explicit_decimal_fields` | function | `app/services/inspection/source_economics.py:616` | 6 | B |
| 24 | `_find_missing_business_dates` | function | `app/services/inspection/source_quality.py:724` | 6 | B |
| 25 | `load_existing_twr_calculation_artifacts` | function | `app/services/inspection/subject_materialization.py:34` | 6 | B |
