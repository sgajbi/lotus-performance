...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `_has_clean_average_weight_shadow_bookkeeping` | function | `app/services/contribution_methodology.py:276` | 5 | A |
| 2 | `_calculate_reset_aware_period_portfolio_return` | function | `app/services/contribution_returns.py:22` | 5 | A |
| 3 | `_build_residual_adjusted_position_timeseries` | function | `app/services/contribution_series.py:57` | 5 | A |
| 4 | `_build_residual_adjusted_daily_contribution_series` | function | `app/services/contribution_series.py:156` | 5 | A |
| 5 | `_build_hierarchy_from_adjusted_position_series` | function | `app/services/contribution_series.py:176` | 5 | A |
| 6 | `_daily_hierarchy_metadata` | function | `app/services/contribution_series.py:255` | 5 | A |
| 7 | `_build_hierarchy_rows` | function | `app/services/contribution_series.py:314` | 5 | A |
| 8 | `build_contribution_source_economics_evidence` | function | `app/services/contribution_source_economics.py:26` | 5 | A |
| 9 | `_stateful_cash_flow_economics` | function | `app/services/contribution_source_economics.py:117` | 5 | A |
| 10 | `_stateful_reason_codes` | function | `app/services/contribution_source_economics.py:178` | 5 | A |
| 11 | `_source_cash_flow_type_counts` | function | `app/services/contribution_source_economics.py:205` | 5 | A |
| 12 | `_has_non_zero_flow` | function | `app/services/contribution_source_economics.py:240` | 5 | A |
| 13 | `get_index_catalog` | method | `app/services/core_integration_service.py:218` | 5 | A |
| 14 | `_lineage_storage_path_unavailable_status` | function | `app/services/durability_health_service.py:77` | 5 | A |
| 15 | `_probe_lineage_storage_write` | function | `app/services/durability_health_service.py:119` | 5 | A |
| 16 | `register_execution` | method | `app/services/execution_registry.py:354` | 5 | A |
| 17 | `get_execution` | method | `app/services/execution_registry.py:524` | 5 | A |
| 18 | `run_twr_calculation_consistency_checks` | function | `app/services/inspection/calculation_consistency.py:49` | 5 | A |
| 19 | `_check_benchmark_relative_pairing` | function | `app/services/inspection/calculation_consistency.py:121` | 5 | A |
| 20 | `_check_relative_breakdown_item` | function | `app/services/inspection/calculation_consistency.py:274` | 5 | A |
| 21 | `_check_block_linking` | function | `app/services/inspection/calculation_consistency.py:353` | 5 | A |
| 22 | `_expected_daily_external_flows` | function | `app/services/inspection/calculation_consistency.py:453` | 5 | A |
| 23 | `_daily_calculation_evidence_mismatches` | function | `app/services/inspection/calculation_consistency.py:467` | 5 | A |
| 24 | `_daily_evidence_semantic_mismatches` | function | `app/services/inspection/calculation_consistency.py:525` | 5 | A |
| 25 | `_expected_daily_capital_linkability_status` | function | `app/services/inspection/calculation_consistency.py:584` | 5 | A |
