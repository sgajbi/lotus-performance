...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `_resolve_compute_job_result` | function | `app/services/async_result_service.py:44` | 5 | A |
| 2 | `_async_result_record_payload_state` | function | `app/services/async_result_store.py:163` | 5 | A |
| 3 | `build_attribution_execution_window` | function | `app/services/attribution_calculation_workflow_service.py:71` | 5 | A |
| 4 | `calculate_attribution_workflow` | function | `app/services/attribution_calculation_workflow_service.py:214` | 5 | A |
| 5 | `_portfolio_group_observation_dates` | function | `app/services/attribution_service.py:85` | 5 | A |
| 6 | `_build_attribution_results_by_period` | function | `app/services/attribution_service.py:110` | 5 | A |
| 7 | `_resolve_attribution_execution_window` | function | `app/services/attribution_service.py:186` | 5 | A |
| 8 | `calculate_attribution` | function | `app/services/attribution_service.py:214` | 5 | A |
| 9 | `_resolved_assignment_identity` | function | `app/services/benchmark_assignment_service.py:20` | 5 | A |
| 10 | `calculate_benchmark_artifacts` | function | `app/services/benchmark_calculation_service.py:81` | 5 | A |
| 11 | `_benchmark_period_result` | function | `app/services/benchmark_calculation_service.py:149` | 5 | A |
| 12 | `_calculate_benchmark_return_from_slice` | function | `app/services/benchmark_calculation_service.py:190` | 5 | A |
| 13 | `_group_benchmark_breakdown_rows` | function | `app/services/benchmark_calculation_service.py:227` | 5 | A |
| 14 | `build_benchmark_exposure_context` | function | `app/services/benchmark_exposure_context_service.py:38` | 5 | A |
| 15 | `_benchmark_id_from_assignment_response` | function | `app/services/benchmark_exposure_context_service.py:110` | 5 | A |
| 16 | `_classification_map_for_request` | function | `app/services/benchmark_exposure_context_service.py:146` | 5 | A |
| 17 | `_index_ids_for_component_series` | function | `app/services/benchmark_exposure_context_service.py:177` | 5 | A |
| 18 | `_iter_component_exposure_points` | function | `app/services/benchmark_exposure_context_service.py:258` | 5 | A |
| 19 | `_accumulate_exposure_point` | function | `app/services/benchmark_exposure_context_service.py:268` | 5 | A |
| 20 | `_group_identity` | function | `app/services/benchmark_exposure_context_service.py:299` | 5 | A |
| 21 | `resolve_freshness_bucket` | function | `app/services/calculation_supportability_service.py:17` | 5 | A |
| 22 | `_supportability_state_and_reason` | function | `app/services/calculation_supportability_service.py:37` | 5 | A |
| 23 | `inspect_composite_twr_from_persisted_facts` | function | `app/services/composite_inspection_service.py:37` | 5 | A |
| 24 | `_upgrade_member_return_fact_schema` | method | `app/services/composite_metadata_store.py:112` | 5 | A |
| 25 | `_ensure_compute_job_can_mark_running` | function | `app/services/compute_job_store.py:301` | 5 | A |
