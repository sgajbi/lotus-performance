...
| 5 | `_calculate_returns_series` | function | `app/services/returns_series_service.py:657` | 32 | E |
| 6 | `run_twr_inspection` | function | `app/services/inspection/twr_inspection_service.py:54` | 31 | E |
| 7 | `build_runtime_status_response` | function | `app/models/runtime_status.py:613` | 30 | D |
| 8 | `_process_pending_jobs` | function | `app/workers/compute_executor_worker.py:59` | 30 | D |
| 9 | `_prepare_data_from_instruments` | function | `engine/attribution.py:210` | 28 | D |
| 10 | `resolve_stateful_returns_series_request` | function | `app/services/returns_series_service.py:909` | 27 | D |
...
| 15 | `build_source_economics_findings` | function | `app/services/inspection/source_economics_findings.py:7` | 24 | D |
...
| 6 | `app/openapi_enrichment.py` | 7.17 | C |
| 7 | `app/services/twr_service.py` | 8.51 | C |
