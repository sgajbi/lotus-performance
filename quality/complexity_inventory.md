...
| High-complexity functions (rank D-F) | 4 |
...
| 5 | `_validate_stateful_portfolio_position_alignment` | function | `app/services/stateful_attribution_input_service.py:283` | 20 | C |
| 6 | `resolve_twr_request` | function | `app/services/twr_mode_service.py:52` | 20 | C |
| 7 | `calculate_twr_response` | function | `app/services/twr_service.py:738` | 20 | C |
| 8 | `build_attribution_supportability_evidence` | function | `engine/attribution_supportability.py:42` | 20 | C |
| 9 | `calculate_daily_ror` | function | `engine/ror.py:18` | 20 | C |
| 10 | `_ensure_schema_documentation` | function | `app/openapi_enrichment.py:510` | 19 | C |
| 11 | `_expected_daily_evidence_semantics` | function | `app/services/inspection/calculation_consistency.py:416` | 19 | C |
| 12 | `analyze_portfolio_position_reconciliation` | function | `app/services/inspection/reconciliation.py:89` | 19 | C |
| 13 | `_calculate_returns_series` | function | `app/services/returns_series_service.py:943` | 19 | C |
| 14 | `_prepare_hierarchical_data` | function | `engine/contribution.py:152` | 19 | C |
| 15 | `_xirr` | function | `engine/mwr.py:53` | 19 | C |
| 16 | `validate_mode_payloads` | method | `app/models/workspace_summary_requests.py:251` | 18 | C |
| 17 | `append_diagnostic_notes` | method | `app/services/contribution_audit.py:88` | 18 | C |
| 18 | `calculate_contribution` | function | `app/services/contribution_service.py:178` | 18 | C |
| 19 | `build_source_economics_findings` | function | `app/services/inspection/source_economics_findings.py:7` | 18 | C |
| 20 | `_runtime_retention_payload_matches_entry` | function | `app/services/operator_action_replay_service.py:136` | 18 | C |
...
The highest complexity functions are concentrated in returns-series modeling and resolution and MWR
calculation. These are real
