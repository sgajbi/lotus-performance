...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `build_portfolio_source_quality_evidence` | function | `app/services/source_quality_evidence.py:13` | 14 | C |
| 2 | `_collect_stateful_mwr_cash_flows` | function | `app/services/stateful_mwr_input_service.py:184` | 14 | C |
| 3 | `_build_twr_results_by_period` | function | `app/services/twr_service.py:673` | 14 | C |
| 4 | `portfolio_timeseries_to_valuation_points` | function | `app/services/valuation_points_service.py:12` | 14 | C |
| 5 | `build_hierarchical_contribution_result` | function | `engine/contribution.py:298` | 14 | C |
| 6 | `_apply_overrides` | function | `engine/policies.py:38` | 14 | C |
| 7 | `_build_artifacts` | function | `app/services/composite_inspection_service.py:114` | 13 | C |
| 8 | `_summarize_currency_source` | function | `app/services/stateful_attribution_input_service.py:509` | 12 | C |
| 9 | `_position_meta_from_row` | function | `app/services/stateful_contribution_input_service.py:221` | 12 | C |
| 10 | `_build_workspace_summary_response` | function | `app/services/workspace_summary_service.py:482` | 12 | C |
| 11 | `_build_instrument_attribution_panel` | function | `engine/attribution.py:270` | 12 | C |
| 12 | `aggregate_attribution_results` | function | `engine/attribution.py:586` | 12 | C |
| 13 | `_prepare_dataframe` | function | `engine/compute.py:163` | 12 | C |
| 14 | `_xirr` | function | `engine/mwr.py:145` | 12 | C |
| 15 | `BenchmarkPerformanceRequest` | class | `app/models/benchmark_requests.py:48` | 11 | C |
| 16 | `_ensure_error_response_examples` | function | `app/openapi_enrichment.py:384` | 11 | C |
| 17 | `calculate_benchmark_artifacts` | function | `app/services/benchmark_calculation_service.py:40` | 11 | C |
| 18 | `_build_exposure_rows` | function | `app/services/benchmark_exposure_context_service.py:202` | 11 | C |
| 19 | `get_queue_stats` | method | `app/services/compute_job_store.py:535` | 11 | C |
| 20 | `calculate_contribution_workflow` | function | `app/services/contribution_calculation_workflow_service.py:98` | 11 | C |
...
component-status helper. `_build_benchmark_groups`,
