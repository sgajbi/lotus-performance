...
| 5 | `run_twr_inspection` | function | `app/services/inspection/twr_inspection_service.py:54` | 31 | E |
| 6 | `build_runtime_status_response` | function | `app/models/runtime_status.py:613` | 30 | D |
