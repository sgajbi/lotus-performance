...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `_summarize_currency_source` | function | `app/services/stateful_attribution_input_service.py:566` | 7 | B |
| 2 | `_build_instruments_data` | function | `app/services/stateful_attribution_input_service.py:648` | 7 | B |
| 3 | `_add_benchmark_group_row` | function | `app/services/stateful_attribution_input_service.py:753` | 7 | B |
| 4 | `_benchmark_group_dimension_value` | function | `app/services/stateful_attribution_input_service.py:835` | 7 | B |
| 5 | `_position_daily_point_market_values` | function | `app/services/stateful_attribution_input_service.py:886` | 7 | B |
| 6 | `_split_position_cash_flows` | function | `app/services/stateful_attribution_input_service.py:948` | 7 | B |
| 7 | `_component_price_series_from_response` | function | `app/services/stateful_benchmark_input_service.py:452` | 7 | B |
| 8 | `_build_component_observations` | function | `app/services/stateful_benchmark_input_service.py:571` | 7 | B |
| 9 | `_position_value_inputs` | function | `app/services/stateful_contribution_input_service.py:213` | 7 | B |
| 10 | `_position_contract_meta_from_row` | function | `app/services/stateful_contribution_input_service.py:255` | 7 | B |
| 11 | `_portfolio_identity_from_payload` | function | `app/services/stateful_input_service.py:1375` | 7 | B |
| 12 | `_collect_stateful_mwr_cash_flows` | function | `app/services/stateful_mwr_input_service.py:200` | 7 | B |
| 13 | `_source_mwr_cash_flow_component` | function | `app/services/stateful_mwr_input_service.py:279` | 7 | B |
| 14 | `_has_single_currency_inputs` | function | `app/services/stateful_mwr_input_service.py:332` | 7 | B |
| 15 | `split_position_cash_flows_in_value_basis` | function | `app/services/stateful_position_row_service.py:14` | 7 | B |
| 16 | `_build_component_observations_from_price_points` | function | `app/services/stateless_benchmark_input_service.py:48` | 7 | B |
| 17 | `_price_point_return_components` | function | `app/services/stateless_benchmark_input_service.py:143` | 7 | B |
| 18 | `_benchmark_currency_state` | function | `app/services/twr_benchmark_supportability.py:124` | 7 | B |
| 19 | `_twr_execution_window_benchmark_fields` | function | `app/services/twr_calculation_service.py:237` | 7 | B |
| 20 | `calculate_twr_workflow` | function | `app/services/twr_calculation_service.py:258` | 7 | B |
| 21 | `_resolve_twr_benchmark_source_input` | function | `app/services/twr_mode_service.py:464` | 7 | B |
| 22 | `_calculate_total_return_from_reset_slice` | function | `app/services/twr_service.py:65` | 7 | B |
| 23 | `_build_portfolio_breakdown_item` | function | `app/services/twr_service.py:547` | 7 | B |
| 24 | `_build_twr_results_by_period` | function | `app/services/twr_service.py:740` | 7 | B |
| 25 | `_valuation_cashflow_total_component` | function | `app/services/valuation_points_service.py:54` | 7 | B |
