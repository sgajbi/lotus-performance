...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `_accumulate_exposure_point` | function | `app/services/benchmark_exposure_context_service.py:299` | 5 | A |
| 2 | `_group_identity` | function | `app/services/benchmark_exposure_context_service.py:330` | 5 | A |
| 3 | `resolve_freshness_bucket` | function | `app/services/calculation_supportability_service.py:17` | 5 | A |
| 4 | `_supportability_state_and_reason` | function | `app/services/calculation_supportability_service.py:37` | 5 | A |
| 5 | `inspect_composite_twr_from_persisted_facts` | function | `app/services/composite_inspection_service.py:37` | 5 | A |
| 6 | `_upgrade_member_return_fact_schema` | method | `app/services/composite_metadata_store.py:112` | 5 | A |
| 7 | `_ensure_compute_job_can_mark_running` | function | `app/services/compute_job_store.py:301` | 5 | A |
| 8 | `register_job` | method | `app/services/compute_job_store.py:394` | 5 | A |
| 9 | `list_recent_recoveries` | method | `app/services/compute_job_store.py:659` | 5 | A |
| 10 | `_apply_recovery_time_filters` | method | `app/services/compute_job_store.py:927` | 5 | A |
| 11 | `_contribution_methodology_notes` | function | `app/services/contribution_audit.py:244` | 5 | A |
| 12 | `contribution_position_count` | function | `app/services/contribution_calculation_workflow_service.py:37` | 5 | A |
| 13 | `_calculate_promoted_stateful_contribution` | function | `app/services/contribution_calculation_workflow_service.py:100` | 5 | A |
| 14 | `_calculate_position_flow_balance_counts` | function | `app/services/contribution_diagnostics.py:240` | 5 | A |
| 15 | `_classify_average_weight_methodology_status` | function | `app/services/contribution_methodology.py:221` | 5 | A |
| 16 | `_has_clean_average_weight_shadow_bookkeeping` | function | `app/services/contribution_methodology.py:263` | 5 | A |
| 17 | `_calculate_reset_aware_period_portfolio_return` | function | `app/services/contribution_returns.py:22` | 5 | A |
| 18 | `_build_residual_adjusted_position_timeseries` | function | `app/services/contribution_series.py:57` | 5 | A |
| 19 | `_build_residual_adjusted_daily_contribution_series` | function | `app/services/contribution_series.py:156` | 5 | A |
| 20 | `_build_hierarchy_from_adjusted_position_series` | function | `app/services/contribution_series.py:176` | 5 | A |
| 21 | `_daily_hierarchy_metadata` | function | `app/services/contribution_series.py:255` | 5 | A |
| 22 | `_build_hierarchy_rows` | function | `app/services/contribution_series.py:314` | 5 | A |
| 23 | `build_contribution_source_economics_evidence` | function | `app/services/contribution_source_economics.py:26` | 5 | A |
| 24 | `_stateful_cash_flow_economics` | function | `app/services/contribution_source_economics.py:117` | 5 | A |
| 25 | `_stateful_reason_codes` | function | `app/services/contribution_source_economics.py:178` | 5 | A |
