...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `get_pending_payload_stats` | method | `app/services/lineage_metadata_store.py:416` | 7 | B |
| 2 | `list_inspection_items` | method | `app/services/lineage_metadata_store.py:507` | 7 | B |
| 3 | `materialize_payload` | method | `app/services/lineage_service.py:72` | 7 | B |
| 4 | `_validate_artifact_filename` | method | `app/services/lineage_service.py:171` | 7 | B |
| 5 | `build_mwr_response` | function | `app/services/mwr_calculation_service.py:42` | 7 | B |
| 6 | `_find_latest_runtime_retention_entry` | function | `app/services/operator_action_guard_service.py:128` | 7 | B |
| 7 | `validate_history_entry_strings` | function | `app/services/operator_action_history_manifest.py:173` | 7 | B |
| 8 | `build_operator_action_lease_snapshot` | function | `app/services/operator_action_lease_service.py:185` | 7 | B |
| 9 | `_read_matching_active_operator_action_leases` | function | `app/services/operator_action_lease_service.py:246` | 7 | B |
| 10 | `_active_lease_payload_fields` | function | `app/services/operator_action_lease_service.py:314` | 7 | B |
| 11 | `_read_recent_reclaimed_leases` | function | `app/services/operator_action_lease_service.py:389` | 7 | B |
| 12 | `_parse_reclaimed_event_payload` | function | `app/services/operator_action_lease_service.py:438` | 7 | B |
| 13 | `_reclaim_stale_lock` | function | `app/services/operator_action_lease_service.py:505` | 7 | B |
| 14 | `resolve_recovery_drill_manual_replay` | function | `app/services/operator_action_replay_service.py:120` | 7 | B |
| 15 | `_runtime_retention_entry_matches` | function | `app/services/operator_action_replay_service.py:154` | 7 | B |
| 16 | `_recovery_drill_payload_identity_matches` | function | `app/services/operator_action_replay_service.py:266` | 7 | B |
| 17 | `_build_result_path` | function | `app/services/operator_navigation_service.py:24` | 7 | B |
| 18 | `collect` | method | `app/services/queue_metrics_service.py:353` | 7 | B |
| 19 | `_calculate_promoted_stateful_returns_series` | function | `app/services/returns_series_calculation_workflow_service.py:102` | 7 | B |
| 20 | `risk_free_points_to_dataframe` | function | `app/services/returns_series_service.py:592` | 7 | B |
| 21 | `_apply_strict_intersection_policy` | function | `app/services/returns_series_service.py:609` | 7 | B |
| 22 | `_apply_selected_fill_method` | function | `app/services/returns_series_service.py:638` | 7 | B |
| 23 | `_build_resolved_stateful_returns_series_request` | function | `app/services/returns_series_service.py:801` | 7 | B |
| 24 | `_resolve_stateful_returns_series_benchmark_id` | function | `app/services/returns_series_service.py:881` | 7 | B |
| 25 | `_build_returns_series_diagnostics` | function | `app/services/returns_series_service.py:1099` | 7 | B |
