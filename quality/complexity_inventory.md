...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `_record_taxonomy_samples` | method | `app/services/inspection/source_economics_collector.py:111` | 15 | C |
| 2 | `collect` | method | `app/services/queue_metrics_service.py:227` | 15 | C |
| 3 | `resolve_stateful_returns_series_request` | function | `app/services/returns_series_service.py:1265` | 15 | C |
| 4 | `_position_meta_from_row` | function | `app/services/stateful_attribution_input_service.py:863` | 15 | C |
| 5 | `_build_component_observations` | function | `app/services/stateful_benchmark_input_service.py:474` | 15 | C |
| 6 | `_build_component_observations_from_price_points` | function | `app/services/stateless_benchmark_input_service.py:39` | 15 | C |
| 7 | `resolve_twr_request` | function | `app/services/twr_mode_service.py:60` | 15 | C |
| 8 | `_resolve_twr_benchmark_source_input` | function | `app/services/twr_mode_service.py:353` | 15 | C |
| 9 | `_resolve_workspace_benchmark_input` | function | `app/services/workspace_summary_service.py:314` | 15 | C |
| 10 | `_build_compute_job_runtime` | function | `app/workers/compute_executor_worker.py:156` | 15 | C |
| 11 | `calculate_benchmark_returns` | function | `engine/benchmarks.py:35` | 15 | C |
| 12 | `_lineage_queue_response` | function | `app/models/runtime_status.py:691` | 14 | C |
| 13 | `TWRBenchmarkRequest` | class | `app/models/twr_requests.py:34` | 14 | C |
| 14 | `_parse_reclaimed_event_payload` | function | `app/services/operator_action_lease_service.py:415` | 14 | C |
| 15 | `collect_runtime_degradation_reasons` | function | `app/services/runtime_status_degradation.py:257` | 14 | C |
| 16 | `build_portfolio_source_quality_evidence` | function | `app/services/source_quality_evidence.py:13` | 14 | C |
| 17 | `_collect_stateful_mwr_cash_flows` | function | `app/services/stateful_mwr_input_service.py:184` | 14 | C |
| 18 | `_build_twr_results_by_period` | function | `app/services/twr_service.py:673` | 14 | C |
| 19 | `portfolio_timeseries_to_valuation_points` | function | `app/services/valuation_points_service.py:12` | 14 | C |
| 20 | `build_hierarchical_contribution_result` | function | `engine/contribution.py:298` | 14 | C |
...
| 13 | `app/services/inspection/calculation_consistency.py` | 15.94 | B |
| 14 | `app/services/inspection/reconciliation.py` | 16.40 | B |
| 15 | `app/services/inspection/source_economics_collector.py` | 16.66 | B |
...
values and daily evidence mismatch assembly were separated from portfolio breakdown traversal. Max
