...
| ---: | --- | --- | --- | ---: | --- |
| 1 | `resolve_async_result` | function | `app/services/async_result_service.py:44` | 6 | B |
| 2 | `build_single_period_attribution_response` | function | `app/services/attribution_response_service.py:19` | 6 | B |
| 3 | `_count_attribution_input_rows` | function | `app/services/attribution_service.py:44` | 6 | B |
| 4 | `resolve_benchmark_identity` | function | `app/services/benchmark_assignment_service.py:20` | 6 | B |
| 5 | `calculate_benchmark_artifacts` | function | `app/services/benchmark_calculation_service.py:71` | 6 | B |
| 6 | `_benchmark_period_result` | function | `app/services/benchmark_calculation_service.py:118` | 6 | B |
| 7 | `calculate_benchmark_workflow` | function | `app/services/benchmark_calculation_workflow_service.py:238` | 6 | B |
| 8 | `_resolve_benchmark_id` | function | `app/services/benchmark_exposure_context_service.py:110` | 6 | B |
| 9 | `_classification_labels_from_catalog_record` | function | `app/services/benchmark_exposure_context_service.py:192` | 6 | B |
| 10 | `build_calculation_supportability` | function | `app/services/calculation_supportability_service.py:33` | 6 | B |
| 11 | `_reconcile_stale_job_row` | method | `app/services/compute_job_store.py:546` | 6 | B |
| 12 | `calculate_contribution_workflow` | function | `app/services/contribution_calculation_workflow_service.py:199` | 6 | B |
| 13 | `_is_average_weight_shadow_cutover_candidate` | function | `app/services/contribution_methodology.py:263` | 6 | B |
| 14 | `_calculate_position_total_return_pct` | function | `app/services/contribution_returns.py:67` | 6 | B |
| 15 | `_build_hierarchy_from_adjusted_position_series` | function | `app/services/contribution_series.py:176` | 6 | B |
| 16 | `_build_period_contribution_series_outputs` | function | `app/services/contribution_service.py:188` | 6 | B |
| 17 | `_prepare_contribution_engine_inputs` | function | `app/services/contribution_service.py:414` | 6 | B |
| 18 | `_contribution_smoothing_residual_reason_codes` | function | `app/services/contribution_smoothing.py:60` | 6 | B |
| 19 | `_available_stateless_economics` | function | `app/services/contribution_source_economics.py:86` | 6 | B |
| 20 | `_unsupported_component_pnl_fields` | function | `app/services/contribution_source_economics.py:129` | 6 | B |
| 21 | `load_json_object_or_none` | function | `app/services/durable_store_json.py:9` | 6 | B |
| 22 | `load_json_string_list_or_default` | function | `app/services/durable_store_json.py:31` | 6 | B |
| 23 | `record_upstream_snapshots` | method | `app/services/execution_registry.py:542` | 6 | B |
| 24 | `_is_replay_of_existing_execution` | method | `app/services/execution_registry.py:638` | 6 | B |
| 25 | `_check_portfolio_daily_calculation_evidence` | function | `app/services/inspection/calculation_consistency.py:391` | 6 | B |
