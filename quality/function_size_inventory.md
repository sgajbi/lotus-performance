...
| ---: | --- | --- | ---: |
| 1 | `_build_artifact_payload` | `app/services/inspection/source_economics.py:413` | 69 |
| 2 | `_calculate_promoted_stateful_returns_series` | `app/services/returns_series_calculation_workflow_service.py:136` | 69 |
| 3 | `StatefulInputService._fetch_position_chunk` | `app/services/stateful_input_service.py:1001` | 68 |
| 4 | `_build_workspace_summary_response` | `app/services/workspace_summary_service.py:547` | 68 |
| 5 | `build_benchmark_exposure_context` | `app/services/benchmark_exposure_context_service.py:39` | 67 |
| 6 | `resolve_contribution_request` | `app/services/contribution_mode_service.py:34` | 67 |
| 7 | `_build_flat_period_contribution_result` | `app/services/contribution_service.py:407` | 67 |
| 8 | `build_runtime_work_item_snapshot` | `app/services/runtime_work_item_service.py:62` | 66 |
| 9 | `build_runtime_recoveries_query` | `app/api/dependencies/runtime_recoveries.py:11` | 65 |
| 10 | `_calculate_promoted_stateful_benchmark_workflow` | `app/services/benchmark_calculation_workflow_service.py:146` | 65 |
| 11 | `run_source_quality_checks` | `app/services/inspection/source_quality.py:146` | 65 |
| 12 | `calculate_mwr_response` | `app/services/mwr_calculation_service.py:215` | 65 |
| 13 | `resolve_mwr_request` | `app/services/mwr_mode_service.py:26` | 65 |
| 14 | `build_runtime_retention_history_snapshot` | `app/services/runtime_retention_history_service.py:91` | 65 |
| 15 | `resolve_attribution_request` | `app/services/attribution_mode_service.py:38` | 64 |
| 16 | `_build_hierarchy_period_contribution_result` | `app/services/contribution_service.py:476` | 64 |
| 17 | `LineageMetadataStore._build_pending_payload_stats_statement` | `app/services/lineage_metadata_store.py:576` | 64 |
| 18 | `_SourceEconomicsSampleCollector._record_taxonomy_samples` | `app/services/inspection/source_economics_collector.py:111` | 63 |
| 19 | `_load_durable_queue_metric_sources` | `app/services/queue_metrics_service.py:259` | 63 |
| 20 | `resolve_stateful_returns_series_request` | `app/services/returns_series_service.py:1594` | 63 |
| 21 | `build_stateful_attribution_input` | `app/services/stateful_attribution_input_service.py:354` | 63 |
| 22 | `_align_and_prepare_data` | `engine/attribution.py:505` | 63 |
| 23 | `_build_contribution_smoothing_evidence` | `app/services/contribution_smoothing.py:96` | 62 |
| 24 | `_resolve_subject_inspection_inputs` | `app/services/inspection/twr_inspection_service.py:220` | 62 |
| 25 | `build_stateful_mwr_input_for_window` | `app/services/stateful_mwr_input_service.py:112` | 62 |
