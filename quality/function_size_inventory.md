...
| 7 | `aggregate_attribution_results` | `engine/attribution.py:586` | 148 |
| 8 | `calculate_benchmark_workflow` | `app/services/benchmark_calculation_workflow_service.py:89` | 147 |
| 9 | `run_twr_inspection` | `app/services/inspection/twr_inspection_service.py:71` | 147 |
| 10 | `calculate_attribution` | `app/services/attribution_service.py:69` | 142 |
| 11 | `_build_external_cashflow_findings` | `app/services/inspection/source_economics_findings.py:267` | 140 |
| 12 | `_build_artifacts` | `app/services/composite_inspection_service.py:114` | 135 |
| 13 | `resolve_stateful_returns_series_request` | `app/services/returns_series_service.py:1265` | 134 |
