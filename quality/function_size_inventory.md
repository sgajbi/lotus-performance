...
| ---: | --- | --- | ---: |
| 1 | `calculate_twr_response` | `app/services/twr_service.py:1184` | 87 |
| 2 | `run_runtime_retention_cleanup` | `app/services/runtime_retention_run_service.py:112` | 83 |
| 3 | `_build_feature_capabilities` | `app/services/integration_capabilities_service.py:96` | 81 |
| 4 | `build_recovery_drill_history_snapshot` | `app/services/recovery_drill_history_service.py:66` | 81 |
| 5 | `build_runtime_recovery_snapshot` | `app/services/runtime_recovery_service.py:67` | 81 |
| 6 | `calculate_contribution` | `app/services/contribution_service.py:716` | 80 |
| 7 | `LineageMetadataStore._build_inspection_query_statements` | `app/services/lineage_metadata_store.py:529` | 80 |
| 8 | `_build_contribution_response` | `app/services/contribution_service.py:635` | 79 |
| 9 | `_build_twr_inspection_response` | `app/services/inspection/twr_inspection_service.py:305` | 79 |
| 10 | `StatefulInputService._fetch_portfolio_chunk` | `app/services/stateful_input_service.py:877` | 79 |
| 11 | `build_runtime_retention_history_snapshot` | `app/services/runtime_retention_history_service.py:91` | 78 |
| 12 | `resolve_contribution_request` | `app/services/contribution_mode_service.py:32` | 77 |
| 13 | `LineageMetadataStore._lease_pending_payloads_postgresql` | `app/services/lineage_metadata_store.py:1043` | 77 |
| 14 | `_build_stateful_calculated_benchmark_input` | `app/services/stateful_benchmark_input_service.py:94` | 75 |
| 15 | `build_runtime_retention_history_query` | `app/api/dependencies/runtime_retention_history.py:11` | 74 |
| 16 | `resolve_attribution_request` | `app/services/attribution_mode_service.py:33` | 74 |
| 17 | `_build_portfolio_engine_diagnostics` | `app/services/contribution_diagnostics.py:62` | 74 |
| 18 | `build_runtime_work_item_snapshot` | `app/services/runtime_work_item_service.py:62` | 74 |
| 19 | `_build_workspace_benchmark_and_active_blocks` | `app/services/workspace_summary_service.py:717` | 74 |
| 20 | `calculate_attribution` | `app/services/attribution_service.py:313` | 73 |
| 21 | `_build_attribution_supportability_reasons` | `engine/attribution_supportability.py:174` | 73 |
| 22 | `run_recovery_drill` | `app/api/endpoints/recovery_drill_history.py:115` | 72 |
| 23 | `calculate_benchmark_response` | `app/services/benchmark_service.py:14` | 72 |
| 24 | `_build_flat_period_contribution_result` | `app/services/contribution_service.py:391` | 72 |
| 25 | `calculate_mwr_response` | `app/services/mwr_calculation_service.py:162` | 72 |
