...
| ---: | --- | --- | ---: |
| 1 | `_build_workspace_benchmark_and_active_blocks` | `app/services/workspace_summary_service.py:717` | 74 |
| 2 | `calculate_attribution` | `app/services/attribution_service.py:313` | 73 |
| 3 | `_build_attribution_supportability_reasons` | `engine/attribution_supportability.py:174` | 73 |
| 4 | `run_recovery_drill` | `app/api/endpoints/recovery_drill_history.py:115` | 72 |
| 5 | `calculate_benchmark_response` | `app/services/benchmark_service.py:14` | 72 |
| 6 | `_build_flat_period_contribution_result` | `app/services/contribution_service.py:407` | 72 |
| 7 | `calculate_mwr_response` | `app/services/mwr_calculation_service.py:162` | 72 |
| 8 | `_resolve_stateful_returns_series_benchmark_source` | `app/services/returns_series_service.py:1096` | 72 |
| 9 | `retrieve_stateful_attribution_source_input` | `app/services/stateful_attribution_input_service.py:87` | 71 |
| 10 | `StatefulInputService._fetch_portfolio_chunk` | `app/services/stateful_input_service.py:877` | 71 |
| 11 | `_build_hierarchy_period_contribution_result` | `app/services/contribution_service.py:481` | 70 |
| 12 | `build_mwr_response` | `app/services/mwr_calculation_service.py:42` | 70 |
| 13 | `_build_workspace_results_by_period` | `app/services/workspace_summary_service.py:632` | 70 |
| 14 | `_process_pending_jobs` | `app/workers/compute_executor_worker.py:113` | 70 |
| 15 | `AverageWeightShadowAuditState._rollout_posture_notes` | `app/services/contribution_audit.py:125` | 69 |
| 16 | `_build_artifact_payload` | `app/services/inspection/source_economics.py:413` | 69 |
| 17 | `_calculate_promoted_stateful_returns_series` | `app/services/returns_series_calculation_workflow_service.py:136` | 69 |
| 18 | `StatefulInputService._fetch_position_chunk` | `app/services/stateful_input_service.py:1002` | 68 |
| 19 | `_build_workspace_summary_response` | `app/services/workspace_summary_service.py:547` | 68 |
| 20 | `build_benchmark_exposure_context` | `app/services/benchmark_exposure_context_service.py:39` | 67 |
| 21 | `resolve_contribution_request` | `app/services/contribution_mode_service.py:34` | 67 |
| 22 | `build_runtime_work_item_snapshot` | `app/services/runtime_work_item_service.py:62` | 66 |
| 23 | `build_runtime_recoveries_query` | `app/api/dependencies/runtime_recoveries.py:11` | 65 |
| 24 | `_calculate_promoted_stateful_benchmark_workflow` | `app/services/benchmark_calculation_workflow_service.py:146` | 65 |
| 25 | `run_source_quality_checks` | `app/services/inspection/source_quality.py:146` | 65 |
