...
Branch: `lp-cr-1427-returns-series-execution-result`
...
| ---: | --- | --- | ---: |
| 1 | `_build_artifacts` | `app/services/composite_inspection_service.py:154` | 89 |
| 2 | `calculate_twr_response` | `app/services/twr_service.py:1184` | 87 |
| 3 | `run_runtime_retention_cleanup` | `app/services/runtime_retention_run_service.py:112` | 83 |
| 4 | `_build_feature_capabilities` | `app/services/integration_capabilities_service.py:96` | 81 |
| 5 | `build_recovery_drill_history_snapshot` | `app/services/recovery_drill_history_service.py:66` | 81 |
| 6 | `build_runtime_recovery_snapshot` | `app/services/runtime_recovery_service.py:67` | 81 |
| 7 | `calculate_contribution` | `app/services/contribution_service.py:716` | 80 |
| 8 | `LineageMetadataStore._build_inspection_query_statements` | `app/services/lineage_metadata_store.py:529` | 80 |
| 9 | `_build_contribution_response` | `app/services/contribution_service.py:635` | 79 |
| 10 | `_build_twr_inspection_response` | `app/services/inspection/twr_inspection_service.py:305` | 79 |
| 11 | `StatefulInputService._fetch_portfolio_chunk` | `app/services/stateful_input_service.py:877` | 79 |
| 12 | `build_runtime_retention_history_snapshot` | `app/services/runtime_retention_history_service.py:91` | 78 |
| 13 | `resolve_contribution_request` | `app/services/contribution_mode_service.py:32` | 77 |
| 14 | `LineageMetadataStore._lease_pending_payloads_postgresql` | `app/services/lineage_metadata_store.py:1043` | 77 |
| 15 | `_build_stateful_calculated_benchmark_input` | `app/services/stateful_benchmark_input_service.py:94` | 75 |
| 16 | `build_runtime_retention_history_query` | `app/api/dependencies/runtime_retention_history.py:11` | 74 |
| 17 | `resolve_attribution_request` | `app/services/attribution_mode_service.py:33` | 74 |
| 18 | `_build_portfolio_engine_diagnostics` | `app/services/contribution_diagnostics.py:62` | 74 |
| 19 | `build_runtime_work_item_snapshot` | `app/services/runtime_work_item_service.py:62` | 74 |
| 20 | `_build_workspace_benchmark_and_active_blocks` | `app/services/workspace_summary_service.py:717` | 74 |
| 21 | `calculate_attribution` | `app/services/attribution_service.py:313` | 73 |
| 22 | `_build_attribution_supportability_reasons` | `engine/attribution_supportability.py:174` | 73 |
| 23 | `run_recovery_drill` | `app/api/endpoints/recovery_drill_history.py:115` | 72 |
| 24 | `calculate_benchmark_response` | `app/services/benchmark_service.py:14` | 72 |
| 25 | `_build_flat_period_contribution_result` | `app/services/contribution_service.py:391` | 72 |
