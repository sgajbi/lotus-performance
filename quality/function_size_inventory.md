...
| 5 | `resolve_stateful_returns_series_request` | `app/services/returns_series_service.py:1046` | 202 |
| 6 | `run_twr_inspection` | `app/services/inspection/twr_inspection_service.py:64` | 197 |
| 7 | `DurableQueueCollector.collect` | `app/services/queue_metrics_service.py:227` | 188 |
| 8 | `build_attribution_supportability_evidence` | `engine/attribution_supportability.py:42` | 184 |
...
| 12 | `_calculate_returns_series` | `app/services/returns_series_service.py:886` | 158 |
