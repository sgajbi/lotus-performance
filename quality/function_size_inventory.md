...
| 5 | `_process_pending_jobs` | `app/workers/compute_executor_worker.py:59` | 219 |
| 6 | `resolve_stateful_returns_series_request` | `app/services/returns_series_service.py:1012` | 202 |
| 7 | `_calculate_returns_series` | `app/services/returns_series_service.py:809` | 201 |
