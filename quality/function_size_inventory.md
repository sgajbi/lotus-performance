...
Branch: `lp-cr-1418-attribution-currency-projection`
...
| ---: | --- | --- | ---: |
| 1 | `build_runtime_retention_history_snapshot` | `app/services/runtime_retention_history_service.py:91` | 97 |
| 2 | `resolve_attribution_request` | `app/services/attribution_mode_service.py:31` | 94 |
| 3 | `_build_analytics_surfaces` | `app/services/integration_capabilities_service.py:405` | 93 |
| 4 | `build_stateful_benchmark_input` | `app/services/stateful_benchmark_input_service.py:57` | 93 |
| 5 | `calculate_twr_response` | `app/services/twr_service.py:1159` | 93 |
| 6 | `_build_flat_period_contribution_result` | `app/services/contribution_service.py:283` | 92 |
| 7 | `build_runtime_status_response` | `app/models/runtime_status.py:838` | 91 |
| 8 | `_build_hierarchy_period_contribution_result` | `app/services/contribution_service.py:377` | 90 |
| 9 | `_calculate_returns_series` | `app/services/returns_series_service.py:1463` | 90 |
| 10 | `_build_artifacts` | `app/services/composite_inspection_service.py:154` | 89 |
| 11 | `run_runtime_retention_cleanup` | `app/services/runtime_retention_run_service.py:112` | 83 |
| 12 | `_build_feature_capabilities` | `app/services/integration_capabilities_service.py:96` | 81 |
| 13 | `build_recovery_drill_history_snapshot` | `app/services/recovery_drill_history_service.py:66` | 81 |
| 14 | `build_runtime_recovery_snapshot` | `app/services/runtime_recovery_service.py:67` | 81 |
| 15 | `calculate_contribution` | `app/services/contribution_service.py:648` | 80 |
| 16 | `LineageMetadataStore._build_inspection_query_statements` | `app/services/lineage_metadata_store.py:529` | 80 |
| 17 | `_build_contribution_response` | `app/services/contribution_service.py:567` | 79 |
| 18 | `_build_twr_inspection_response` | `app/services/inspection/twr_inspection_service.py:305` | 79 |
| 19 | `StatefulInputService._fetch_portfolio_chunk` | `app/services/stateful_input_service.py:877` | 79 |
