...
| 9 | `calculate_attribution` | `app/services/attribution_service.py:69` | 142 |
| 10 | `_build_external_cashflow_findings` | `app/services/inspection/source_economics_findings.py:267` | 140 |
| 11 | `_build_artifacts` | `app/services/composite_inspection_service.py:114` | 135 |
| 12 | `resolve_stateful_returns_series_request` | `app/services/returns_series_service.py:1265` | 134 |
...
after lineage queue response mapping was isolated.
