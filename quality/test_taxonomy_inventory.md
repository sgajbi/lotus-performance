...
| Test functions inventoried | 3053 |
...
| 19 | `tests/unit/services/test_benchmark_exposure_context_service.py` | unit | 34 | uncategorized |
| 20 | `tests/unit/engine/test_mwr.py` | unit | 33 | analytics_domain |
...
| 27 | `tests/unit/services/test_twr_inspection_service.py` | unit | 29 | analytics_domain |
| 28 | `tests/integration/test_returns_series_api.py` | integration | 26 | api_or_runtime |
| 29 | `tests/unit/services/test_queue_metric_builders.py` | unit | 26 | observability_or_readiness |
...
contract/governance coverage, but 1225 test functions remain uncategorized by the first-wave
