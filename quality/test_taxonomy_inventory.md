...
| Test functions inventoried | 3419 |
...
| ---: | --- | --- | ---: | --- |
| 1 | `tests/unit/services/test_returns_series_service.py` | unit | 91 | analytics_domain |
...
`1545` analytics-domain test functions, and `982` uncategorized test functions. The enforced
