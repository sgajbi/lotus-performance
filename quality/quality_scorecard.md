...
| Collected tests | 2,035 | 3,248 | 1,213 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 61 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1491 moved `build_stateful_mwr_input_for_window(...)` out of the top-25 table, and the largest production functions now measure `61` lines |
