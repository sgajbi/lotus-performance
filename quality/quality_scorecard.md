...
| Python LOC | 104,454 | 174,145 | 69,691 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,424 | 1,389 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 55 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; `_load_durable_queue_metric_sources(...)` dropped out of the top-45 table after durable queue, recovery-drill, and runtime-retention source loading moved behind named private helpers |
...
| Latest architecture signal | 1 | `_load_durable_queue_metric_sources(...)` dropped out of the top-45 function-size inventory after core queue, recovery-drill, and runtime-retention source loading moved behind focused collector helpers; largest production functions still measure `55` lines, and architecture-boundary, duplicate-code, complexity, and taxonomy gates remain clean. |
