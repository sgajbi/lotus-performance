...
| Python test modules | 228 | 318 | 90 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Collected tests | 2,035 | 3,933 | 1,898 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
