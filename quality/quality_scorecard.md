...
| Python test modules | 228 | 321 | 93 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Collected tests | 2,035 | 3,967 | 1,932 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
