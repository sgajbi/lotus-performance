...
| Python LOC | 104,454 | 110,043 | 5,589 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,133 | 98 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
