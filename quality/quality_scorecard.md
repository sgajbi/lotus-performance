...
| Python LOC | 104,454 | 148,465 | 44,011 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,740 | 705 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
