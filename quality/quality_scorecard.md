...
| Python LOC | 104,454 | 142,971 | 38,517 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,197 | 1,162 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 74 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1448 moved `calculate_contribution(...)` out of the top-25 table, so the largest production function is now `_build_workspace_benchmark_and_active_blocks(...)` at `74` lines |
