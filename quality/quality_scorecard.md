...
| Python LOC | 104,454 | 152,882 | 48,428 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,902 | 867 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
