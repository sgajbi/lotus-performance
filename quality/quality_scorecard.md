...
| Python LOC | 104,454 | 163,204 | 58,750 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,176 | 1,141 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 74 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1443 moved `build_runtime_work_item_snapshot(...)` from `74` to `66` lines and out of the top-25 table by isolating durable-metadata-unavailable snapshot assembly; the largest production functions are now five functions tied at `74` lines |
