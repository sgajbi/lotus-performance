...
| Python test modules | 228 | 317 | 89 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Collected tests | 2,035 | 3,930 | 1,895 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
