...
| Collected tests | 2,035 | 2,201 | 166 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| High-complexity functions (D-F) | unknown | 6 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
| Average maintainability index | unknown | 55.83 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
