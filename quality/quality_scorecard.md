...
| Python LOC | 104,454 | 150,454 | 46,000 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,819 | 784 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
