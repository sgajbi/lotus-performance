...
| Python LOC | 104,454 | 118,256 | 13,802 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,330 | 295 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
