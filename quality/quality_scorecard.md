...
| Python LOC | 104,454 | 145,326 | 40,872 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,628 | 593 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
