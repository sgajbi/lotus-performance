...
| Python LOC | 104,454 | 144,843 | 40,389 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,612 | 577 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
