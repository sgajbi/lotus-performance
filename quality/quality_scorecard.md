...
| Collected tests | 2,035 | 3,253 | 1,218 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 60 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1497 moved `_calculate_dietz_mwr_result(...)` from `61` to `57` lines, and the largest production functions now measure `60` lines |
