...
| Python LOC | 104,454 | 120,717 | 16,263 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,393 | 358 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Average maintainability index | unknown | 55.47 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
