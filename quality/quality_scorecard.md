...
| Python LOC | 104,454 | 110,587 | 6,133 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,152 | 117 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| High-complexity functions (D-F) | unknown | 19 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
