...
| Python LOC | 104,454 | 145,394 | 40,940 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,630 | 595 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
