...
| Python LOC | 104,454 | 146,426 | 41,972 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,659 | 624 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
