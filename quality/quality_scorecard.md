...
| Python LOC | 104,454 | 144,742 | 40,288 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,606 | 571 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
