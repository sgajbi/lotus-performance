...
| Collected tests | 2,035 | 3,250 | 1,215 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 61 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1493 moved `_build_twr_inspection_response(...)` out of the top-25 table, and the largest production functions continue to measure `61` lines |
