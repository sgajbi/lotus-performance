...
| Python test modules | 228 | 311 | 83 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Collected tests | 2,035 | 3,865 | 1,830 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
