...
| Python LOC | 104,454 | 154,800 | 50,346 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,995 | 960 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
