...
| Python LOC | 104,454 | 121,014 | 16,560 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,399 | 364 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
