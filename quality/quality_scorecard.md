...
| Python LOC | 104,454 | 145,679 | 41,225 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,638 | 603 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
