...
| --- | ---: | ---: | ---: | --- | --- |
| Python files | 480 | 545 | 65 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Python package markers | 18 | 18 | 0 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Python LOC | 104,454 | 151,116 | 46,662 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Python test modules | 228 | 261 | 33 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Collected tests | 2,035 | 2,840 | 805 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
