...
| Collected tests | 2,035 | 3,244 | 1,209 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Average maintainability index | unknown | 54.93 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
| Largest functions by LOC | unknown | 62 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1487 moved `resolve_contribution_request(...)` out of the top-25 table, and the largest production functions now measure `62` lines |
