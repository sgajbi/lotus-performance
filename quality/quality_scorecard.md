...
| Python LOC | 104,454 | 155,530 | 51,076 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,031 | 996 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
