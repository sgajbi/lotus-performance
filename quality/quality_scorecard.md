...
| Collected tests | 2,035 | 3,221 | 1,186 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 67 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1467 moved `_build_workspace_summary_response(...)` out of the top-25 table, so the largest production functions are now `build_benchmark_exposure_context(...)`, `resolve_contribution_request(...)`, and `_build_flat_period_contribution_result(...)` at `67` lines |
...
| Integration/API/runtime test functions | unknown | 598 | n/a | measured | `quality/test_taxonomy_inventory.md`; `quality/refactor_health_report.md` |
