...
| Collected tests | 2,035 | 3,217 | 1,182 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 69 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1463 moved `AverageWeightShadowAuditState._rollout_posture_notes(...)` out of the top-25 table, so the largest production functions remain `69` lines |
