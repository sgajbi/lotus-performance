...
| Python LOC | 104,454 | 111,861 | 7,407 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,187 | 152 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| High-complexity functions (D-F) | unknown | 12 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
