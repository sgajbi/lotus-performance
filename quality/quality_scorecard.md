...
| Python LOC | 104,454 | 145,511 | 41,057 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,634 | 599 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
