...
| Python LOC | 104,454 | 149,920 | 45,466 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,800 | 765 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Average maintainability index | unknown | 55.01 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
