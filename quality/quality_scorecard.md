...
| Python LOC | 104,454 | 145,091 | 40,637 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,620 | 585 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
