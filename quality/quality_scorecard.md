...
| Python LOC | 104,454 | 172,597 | 68,143 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,404 | 1,369 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Latest architecture signal | 1 | `get_benchmark_exposure_context(...)` dropped out of the top-30 function-size inventory after endpoint execution lifecycle orchestration moved behind `app/services/benchmark_exposure_context_workflow_service.py`; router-thinness, architecture-boundary, OpenAPI, and taxonomy gates remain clean. |
