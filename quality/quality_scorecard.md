...
| Python LOC | 104,454 | 172,957 | 68,503 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,410 | 1,375 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 57 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; current largest production functions are three functions tied at `57` lines, led by `StatefulInputService._fetch_position_chunk(...)` |
...
| Latest architecture signal | 1 | `build_stateful_contribution_input(...)` dropped out of the top-30 function-size inventory after portfolio valuation projection and sorted position response projection moved behind focused helper boundaries; architecture-boundary and taxonomy gates remain clean. |
