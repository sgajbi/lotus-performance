...
| Collected tests | 2,035 | 4,077 | 2,042 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Integration/API/runtime test functions | unknown | 749 | n/a | enforced | `quality/test_taxonomy_inventory.md`; `quality/refactor_health_report.md`; `make quality-test-taxonomy-gate` |
