...
| Python LOC | 104,454 | 118,816 | 14,362 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,343 | 308 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
