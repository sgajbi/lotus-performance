...
| Collected tests | 2,035 | 3,254 | 1,219 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 60 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1498 moved `_calculate_xirr_mwr_attempt(...)` out of the top-25 table, and the largest production functions continue to measure `60` lines |
