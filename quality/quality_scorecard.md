...
| Python LOC | 104,454 | 148,550 | 44,096 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,743 | 708 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
