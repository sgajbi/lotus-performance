...
| --- | ---: | ---: | ---: | --- | --- |
| Python files | 480 | 532 | 52 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Python package markers | 18 | 18 | 0 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Python LOC | 104,454 | 109,614 | 5,160 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Router/middleware oversized function findings (`--threshold 80`) | unknown | 2 | n/a | measured | `quality/router_middleware_thinness_inventory.md`; `quality/refactor_health_report.md` |
