...
| Python LOC | 104,454 | 145,436 | 40,982 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,631 | 596 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
