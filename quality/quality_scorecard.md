...
| Collected tests | 2,035 | 2,205 | 170 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| High-complexity functions (D-F) | unknown | 3 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
