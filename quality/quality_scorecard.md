...
| Collected tests | 2,035 | 3,223 | 1,188 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 67 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1469 moved `resolve_contribution_request(...)` from `67` to `62` lines, so the largest production function is now `_build_flat_period_contribution_result(...)` at `67` lines |
