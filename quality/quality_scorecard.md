...
| Collected tests | 2,035 | 3,752 | 1,717 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Uncategorized test functions | unknown | 951 | n/a | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate`; issue #429 added workspace-summary operator-navigation API path proof while staying below the uncategorized ceiling |
