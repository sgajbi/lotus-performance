...
| Collected tests | 2,035 | 3,243 | 1,208 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 62 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1486 moved `_align_and_prepare_data(...)` out of the top-25 table, and the largest production functions now measure `62` lines |
