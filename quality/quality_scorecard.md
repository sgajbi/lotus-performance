...
| Python LOC | 104,454 | 155,512 | 51,058 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,030 | 995 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Average maintainability index | unknown | 54.81 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
