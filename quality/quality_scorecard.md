...
| Collected tests | 2,035 | 3,220 | 1,185 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 68 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1466 moved `StatefulInputService._fetch_position_chunk(...)` from `68` to `65` lines, so the largest production function is now `_build_workspace_summary_response(...)` at `68` lines |
