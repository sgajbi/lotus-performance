...
| Python LOC | 104,454 | 152,051 | 47,597 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,873 | 838 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Average maintainability index | unknown | 54.96 | n/a | measured | `quality/complexity_inventory.md`; `quality/refactor_health_report.md` |
