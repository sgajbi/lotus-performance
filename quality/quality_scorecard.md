...
| Python LOC | 104,454 | 173,284 | 68,830 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,414 | 1,379 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 56 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; current largest production functions start at `56` lines, led by `run_twr_inspection(...)` |
...
| Latest architecture signal | 1 | `ComputeJobStore._build_inspection_statements(...)` dropped out of the top-30 function-size inventory after reclaimable and standard-status inspection statement assembly moved behind focused helper boundaries; architecture-boundary, duplicate-code, complexity, and taxonomy gates remain clean. |
