...
| Python LOC | 104,454 | 172,292 | 67,838 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,399 | 1,364 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Contract/governance test functions | unknown | 110 | n/a | measured | `quality/test_taxonomy_inventory.md`; `quality/refactor_health_report.md` |
