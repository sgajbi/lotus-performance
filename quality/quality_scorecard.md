...
| Collected tests | 2,035 | 3,215 | 1,180 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 70 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1461 moved `_build_workspace_results_by_period(...)` out of the top-25 table, so the largest production function is now `_process_pending_jobs(...)` at `70` lines |
