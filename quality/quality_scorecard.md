...
| Python LOC | 104,454 | 174,386 | 69,932 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,426 | 1,391 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 55 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; `_retrieve_stateful_attribution_sources(...)` dropped out of the top-45 table after stateful attribution source retrieval moved behind a typed request boundary and public DTO projection helper |
...
| Uncategorized test functions | unknown | 1138 | n/a | enforced ceiling | `quality/test_taxonomy_inventory.md`; `make quality-test-taxonomy-gate` |
...
| Latest architecture signal | 1 | `_retrieve_stateful_attribution_sources(...)` dropped out of the top-45 function-size inventory after stateful attribution source retrieval moved behind `_StatefulAttributionSourceRetrievalRequest` and public DTO projection moved behind `_stateful_attribution_source_input_from_bundle(...)`; largest production functions still measure `55` lines, architecture-boundary and duplicate-code findings remain `0`, max CC remains `5`, and test-taxonomy floors remain satisfied. |
