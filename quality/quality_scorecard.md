...
| Collected tests | 2,035 | 3,247 | 1,212 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 62 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1490 moved `calculate_mwr_response(...)` out of the top-25 table, and the largest production function now measures `62` lines |
