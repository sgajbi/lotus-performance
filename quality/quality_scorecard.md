...
| Python LOC | 104,454 | 144,631 | 40,177 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,604 | 569 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
