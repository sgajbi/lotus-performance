...
| Collected tests | 2,035 | 3,222 | 1,187 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 67 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1468 moved `build_benchmark_exposure_context(...)` from `67` to `61` lines, so the largest production functions are now `resolve_contribution_request(...)` and `_build_flat_period_contribution_result(...)` at `67` lines |
