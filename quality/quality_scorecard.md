...
| Python LOC | 104,454 | 122,568 | 18,114 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,437 | 402 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
