...
| Python LOC | 104,454 | 162,526 | 58,072 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,164 | 1,129 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 79 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1437 moved `_build_twr_inspection_response(...)` from `79` to `61` lines by isolating support-brief response projection; the largest production function is now `StatefulInputService._fetch_portfolio_chunk(...)` at `79` lines |
