...
| --- | ---: | ---: | ---: | --- | --- |
| Python files | 480 | 531 | 51 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Python package markers | 18 | 18 | 0 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Python LOC | 104,454 | 109,595 | 5,141 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,117 | 82 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Router/middleware oversized function findings (`--threshold 80`) | unknown | 3 | n/a | measured | `quality/router_middleware_thinness_inventory.md`; `quality/refactor_health_report.md` |
