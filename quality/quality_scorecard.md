...
| Python LOC | 104,454 | 173,072 | 68,618 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 3,411 | 1,376 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 57 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; current largest production functions are two functions tied at `57` lines: `build_hierarchical_contribution_result(...)` and `_calculate_dietz_mwr_result(...)` |
...
| Latest architecture signal | 1 | `StatefulInputService._fetch_position_chunk(...)` dropped out of the top-30 function-size inventory after position page fetching and source-lineage snapshot recording moved behind a focused helper boundary; architecture-boundary and taxonomy gates remain clean. |
