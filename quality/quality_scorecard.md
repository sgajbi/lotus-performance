...
| Python test modules | 228 | 322 | 94 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
| Collected tests | 2,035 | 3,974 | 1,939 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
