...
| Collected tests | 2,035 | 3,237 | 1,202 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 64 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1480 moved `resolve_attribution_request(...)` out of the top-25 table, and the largest production function is now `LineageMetadataStore._build_pending_payload_stats_statement(...)` at `64` lines |
