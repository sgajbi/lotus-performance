...
| Collected tests | 2,035 | 3,218 | 1,183 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Largest functions by LOC | unknown | 69 | n/a | measured | `quality/function_size_inventory.md`; `quality/refactor_health_report.md`; LP-CR-1464 moved `_build_artifact_payload(...)` out of the top-25 table, so the largest production function is now `_calculate_promoted_stateful_returns_series(...)` at `69` lines |
