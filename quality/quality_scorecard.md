...
| Python LOC | 104,454 | 120,511 | 16,057 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
...
| Collected tests | 2,035 | 2,386 | 351 | measured | `quality/baseline_report.md`; `quality/refactor_health_report.md` |
